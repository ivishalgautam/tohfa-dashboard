...
export function ProductForm({
  ...
  const watchInputs = watch("variants");
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        data && setValue("sale_price", data?.sale_price);
                        ...
                        {discountFields?.map((field, key) => (
                          ...
                          >
                            <div>
                              ...
                              <Input
                                {...register(
                                  `discount.${key}.discount_quantity`,
                                  {
                      ...
                      {fields?.length > 0 ? (
                        <TooltipContent>
                          <p className="text-center">
                            Since you have added variants, you can only edit
                            this <br /> field in the variant section below.
                          </p>
                        </TooltipContent>
                      ) : (
                        <></>
